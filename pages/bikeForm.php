...
<form action="<?php echo $targetURL ?>" method="post" name="add-bicycle" onsubmit="return validateAddBicycle();">
    <fieldset>
        ...
        Gear Type:<br>
        <input type="radio" name="gearType" value="1" <?php echo getChecked("gearType", "1") ?> required>Nabenschaltung<br>
        <input type="radio" name="gearType" value="2" <?php echo getChecked("gearType", "2") ?>required>Kettenschaltung<br>
